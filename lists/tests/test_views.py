...
class HomePageTest(TestCase):
    ...
    def test_home_pagr_renders_home_template(self):
...
class ListViewTest(TestCase):
    ...
    def test_displays_only_items_for_that_list(self):
        ...
        other_list = List.objects.create()
        Item.objects.create(text='other_list_item 1', list=other_list)
        Item.objects.create(text='other_list_item 2', list=other_list)
